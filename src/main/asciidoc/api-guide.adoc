...
=== 회원 조회
operation::member-controller-test/get_member[snippets='curl-request,http-request,http-response,httpie-request,path-parameters,request-body,response-body,response-fields']

=== 회원 리스트
operation::member-controller-test/get_members[snippets='curl-request,http-request,http-response,httpie-request,response-body,response-fields']

=== 회원가입
operation::member-controller-test/sign_up[snippets='request-fields,http-request,http-response']
